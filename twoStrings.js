function processData(input) {
    ...
    for(let i=0;i<len;i+=2){ //loop every other item.
        ...
        let aLen = a.length; //again, move O(n) operation out.
        mainloop: for(let valueA of a){ //loop through each letter of item a.
            ...
            if(aLen-1 == x){ //if we've made it to the end without a match print no.
                console.log('NO');
            }
        }
    }
